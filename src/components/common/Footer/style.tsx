...
const navClsx = 'flex flex-col gap-y-7 gap-x-12 mb-10 sm:gap-x-24 sm:mb-0 md:flex-row md:gap-y-0';

const navBlockClsx = 'space-y-2 text-sm';

const navTitleClsx = 'text-sm font-normal text-text-primary';

const navLinkClsx = 'block text-text-tertiary';

const infoClsx = 'flex flex-col justify-center items-center mx-auto md:items-end md:mr-0 md:ml-auto gap-6';
