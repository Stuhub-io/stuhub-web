...
export const CreateNewPageModal = () => {
  ...
  const title = createDocData?.name
  const content = createDocData?.document.json_content ?? ({} as JSONContent)

  const setContent = useCallback(
    (value: JSONContent) => {
      setCreateDocData?.((pageInput) => ({
        ...(pageInput ?? {
          name: '',
    ...
    [organization?.pkid, selectedParent?.pkid, setCreateDocData],
  )
