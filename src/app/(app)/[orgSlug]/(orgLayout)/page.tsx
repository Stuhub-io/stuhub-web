...
import { RiArrowUpSLine, RiFolder3Fill, RiHardDrive2Fill } from 'react-icons/ri'
  ...
  return (
    <div className="flex max-h-[100%] flex-col md:px-4">
      <div className="my-8 grid grid-cols-1 gap-2">
        <Typography level="h4">Welcome To Hub</Typography>
        <FolderViewToolbar
          isViewOnly
          viewType={viewType}
      ...
      <div className="flex flex-col gap-4">
        <div>
          <Button variant="flat" startContent={<RiArrowUpSLine size={16} />}>
            Suggest Files
          </Button>
        </div>
        <PageListView
